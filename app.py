...
# Heatsink and evolution analysis
...
def data_analysis():
    ...
    # Navigation within Data Analysis
...
def contour_plots():
    ...
    # Retrieve preloaded models and data from session state
...
def minimise_cr_page():
    ...
    # User input for d and PCO₂ with dynamic min and max values
    ...
    # Convert PCO₂ to log10 scale as required by the model
...
def physical_relationship_analysis():
    ...
    # Ensure heatsink data exists in session state
    ...
    if st.session_state.heatsink_loaded:
        ...
        # Input for evolutionary analysis parameters
        ...
        if st.button("Run Heatsink Analysis"):
            try:
                # Call run_heatsink_analysis with user-defined parameters
                run_heatsink_analysis(pop_size, pop_retention, iterations)
